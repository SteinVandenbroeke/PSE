...
//    std::cout << vaccin->getVaccinType() << std::endl;
...
//        std::cout << "VACCINS LEFT" << std::endl;
//        std::cout << secondShot << std::endl;
...
void VaccinationCenter::vaccinateCenter(std::ostream &stream) {
    ...
    i = vaccinateCenter(getVaccin(false), stream, vaccinated + vaccinsUsed);
    vaccinated += i.first;
    vaccinsUsed += i.second;
